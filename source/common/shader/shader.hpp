...
namespace our {
    ...
    public:
        ShaderProgram(){
            ...
            program = glCreateProgram();            // program is a GLUint that uniquely identifies the created program
        }
        ~ShaderProgram(){
        ...
        // We need to use the same program, so there is no need to copy or assign it
    };
